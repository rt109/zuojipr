...
import splashMessages from "./splash-texts.json";
...
import pokedexUiHandler from "./pokedex-ui-handler.json";
import filterText from "./filter-text.json";
import pokemonEvolutions from "./pokemon-evolutions.json";
import trainersCommon from "./trainers-common.json";

import pokemonCategory from "./pokemon-category.json";


import mysteryEncounterMessages from "./mystery-encounter-texts.json";
...
export const zhCnConfig = {
  ...
  pokemonCategory,
  //ee 老翻译
  "mysteryEncounters/mysteriousChallengers":mysteriousChallengers,
    "mysteryEncounters/mysteriousChest":mysteriousChest,
    "mysteryEncounters/darkDeal":darkDeal,
    "mysteryEncounters/fightOrFlight":fightOrFlight,
    "mysteryEncounters/slumberingSnorlax":slumberingSnorlax,
    "mysteryEncounters/trainingSession":trainingSession,
    "mysteryEncounters/departmentStoreSale":departmentStoreSale,
    "mysteryEncounters/shadyVitaminDealer":shadyVitaminDealer,
    "mysteryEncounters/fieldTrip":fieldTrip,
    "mysteryEncounters/safariZone":safariZone,
    "mysteryEncounters/lostAtSea":lostAtSea,
    "mysteryEncounters/fieryFallout":fieryFallout,
    "mysteryEncounters/theStrongStuff":theStrongStuff,
    "mysteryEncounters/thePokemonSalesman":pokemonSalesman,
    "mysteryEncounters/anOfferYouCantRefuse":offerYouCantRefuse,
    "mysteryEncounters/delibirdy":delibirdy,
    "mysteryEncounters/absoluteAvarice":absoluteAvarice,
    "mysteryEncounters/aTrainersTest":aTrainersTest,
    "mysteryEncounters/trashToTreasure":trashToTreasure,
    "mysteryEncounters/berriesAbound":berriesAbound,
    "mysteryEncounters/clowningAround":clowningAround,
    "mysteryEncounters/partTimer":partTimer,
    "mysteryEncounters/dancingLessons":dancingLessons,
    "mysteryEncounters/weirdDream":weirdDream,
    "mysteryEncounters/theWinstrateChallenge":theWinstrateChallenge,
    "mysteryEncounters/teleportingHijinks":teleportingHijinks,
    "mysteryEncounters/bugTypeSuperfan":bugTypeSuperfan,
    "mysteryEncounters/funAndGames":funAndGames,
    "mysteryEncounters/uncommonBreed":uncommonBreed,
    "mysteryEncounters/globalTradeSystem":globalTradeSystem,
    "mysteryEncounters/theExpertPokemonBreeder":expertPokemonBreeder,
